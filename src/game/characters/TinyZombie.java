...
class TinyZombie extends Character {
    private enum State {
    ...
    public void init() {
        ...
        idleTextures[0] = tm.getTexture("tiny_zombie_idle_anim_f0");
        idleTextures[1] = tm.getTexture("tiny_zombie_idle_anim_f1");
        idleTextures[2] = tm.getTexture("tiny_zombie_idle_anim_f2");
        idleTextures[3] = tm.getTexture("tiny_zombie_idle_anim_f3");

        runTextures[0] = tm.getTexture("tiny_zombie_run_anim_f0");
        runTextures[1] = tm.getTexture("tiny_zombie_run_anim_f1");
        runTextures[2] = tm.getTexture("tiny_zombie_run_anim_f2");
        runTextures[3] = tm.getTexture("tiny_zombie_run_anim_f3");

        hitTexture = tm.getTexture("tiny_zombie_idle_anim_f2");
